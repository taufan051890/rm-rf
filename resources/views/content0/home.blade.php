          ...
          <div class="row clearfix">
              ...
              <div class="content-column col-md-7 col-sm-7 col-xs-12">
                    <div class="content-box">
                        <h2>Create your website<br>
                           responsive with us at <br>
                           <span style="color: #70e1b8;">rm</span>
                           <span style="color: #f7787e;">-rf</span>
                           <span style="color: #76e3f1;">.Studio</span>
                         </h2>
                         <div class="text">
                               We proud to help various products or business.
                               And we always support every businessman both beginner or big businessman.
                               " Believe in us will not disappoint "
                         </div>
      ...
      <!--Title-->
        <div class="sec-title centered">
          ...
          <h4 class="subtitle">What we do</h4>
            <h2>WHY YOU SHOULD CREATE A WEBSITE FOR YOUR BUSINESS?</h2>
        </div>

        <div class="row clearfix">
          <!--Default Service Item-->
            <div class="default-service-item col-md-4 col-sm-6 col-xs-12">
              <div class="inner-box wow fadeInUp" style="min-height: 463px;">
                  <figure class="icon-box"><img src="images/icons/service-icons/icon-2.png" alt=""></figure>
                    <h3><a href="services.html">Easy to do and Fast</a></h3>
                    <div class="text">
                       Because now everyone wants something simple to do. And now it's time
                       for businessman to use technology to improve the business you've created
                    </div>
                </div>
            </div>
            ...
            <!--Default Service Item-->
            <div class="default-service-item col-md-4 col-sm-6 col-xs-12">
              <div class="inner-box wow fadeInDown" style="min-height: 463px;">
                  <figure class="icon-box"><img src="images/icons/service-icons/icon-1.png" alt=""></figure>
                    <h3><a href="services.html">Done just by Clicking</a></h3>
                    <div class="text">
                      Because now everyone wants something that does not take much
                      time and executes it with just 1 click
                    </div>
                </div>
            </div>
            ...
            <div class="default-service-item col-md-4 col-sm-6 col-xs-12">
              <div class="inner-box wow fadeInUp" style="min-height: 463px;">
                  <figure class="icon-box"><img src="images/icons/service-icons/icon-3.png" alt=""></figure>
                    ...
                    <div class="text">
                      If using a traditional marketing system, your marketing activities are limited to a place.
                      While using online marketing, you can market the product anywhere and anytime.
                     </div>
                </div>
            </div>
